          ...
          >
            ...
            <div className="flex-shrink-0 ml-16">
              <div className="w-80 h-64 flex items-center justify-center">
                <div className="text-9xl opacity-100"><img src={whoWeAre} alt="" /></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="flex-shrink-0 mr-16">
              <div className="w-80 h-64 flex items-center justify-center">
                <div className="text-9xl opacity-100"><img src={goal} alt="" /></div>
              </div>
            </div>
      ...
      <section className={`px-8 py-20 ${isDarkMode ? "bg-black" : "bg-white"}`}>
        <div className="max-w-5xl mx-auto">
          <div className="rounded-3xl overflow-hidden">
            ...
            >
              <div className="text-9xl opacity-100"><img src={balloons} alt="" /></div>
            </div>
          </div>
        </div>
      </section>
          ...
          >
            ...
            <div className="flex-shrink-0 ml-16">
              <div className="w-64 h-32 flex items-center justify-center">
                <div className="text-7xl opacity-100"><img src={achievements} alt="" /></div>
              </div>
            </div>
          </div>
      ...
      <section className={`px-8 py-20 ${isDarkMode ? "bg-black" : "bg-white"}`}>
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="flex-shrink-0 ml-16">
              <div className="w-64 h-32 flex items-center justify-center">
                <div className="text-7xl opacity-100"><img src={services} alt="" /></div>
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex-shrink-0 mr-12">
              <div className="w-32 h-32 flex items-center justify-center">
                <div className="text-7xl"><img src={courseLevel} alt="" /></div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-8">
                ...
                <div className="flex-shrink-0">
                  ...
                  <div className="w-64 h-64 flex items-center justify-center bg-blue-50 rounded-2xl">
                    <div className="text-8xl"><img src={programing} alt="" /></div>
                  </div>
                </div>
            ...
            >
              <div className="flex items-start gap-8">
                ...
                <div className="flex-shrink-0">
                  ...
                  <div className="w-64 h-64 flex items-center justify-center bg-blue-50 rounded-2xl">
                    <div className="text-8xl"><img src={workShop} alt="" /></div>
                  </div>
                </div>
            ...
            >
              <div className="flex items-start gap-8">
                ...
                <div className="flex-shrink-0">
                  ...
                  <div className="w-64 h-64 flex items-center justify-center bg-blue-50 rounded-2xl">
                    <div className="text-8xl"><img src={study} alt="" /></div>
                  </div>
                </div>
          ...
          >
            <div className="flex-shrink-0">
              <div className="w-48 h-48 flex items-center justify-center">
                <div className="text-9xl"><img src={support} alt="" /></div>
              </div>
            </div>
            <div className="flex-1">
              <h2 className="text-5xl font-bold text-white mb-4">
