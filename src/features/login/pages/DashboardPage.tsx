...
const topRatedUsers = [
  { id: 1, name: 'Mahmoud Emad', level: 'Level 1', points: 2500, rank: 1, avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=user1' },
  { id: 2, name: 'Mahmoud Emad', level: 'Level 1', points: 2400, rank: 2, avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=user2' },
  { id: 3, name: 'Mahmoud Emad', level: 'Level 1', points: 1500, rank: 3, avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=user3' },
  { id: 4, name: 'Mahmoud Emad', level: 'Level 1', points: 1200, rank: 4, avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=user4' },
];
...
export const DashboardPage = () => {
  ...
  const getRankBadgeColor = (rank: number) => {
    switch(rank) {
      ...
      case 3: return 'bg-gradient-to-r from-purple-400 to-purple-600';
  ...
  return (
    <div className={`min-h-screen ${bgClass} transition-colors duration-300`}>
      {/* Navigation Header */}
      <nav className={`${navBgClass} shadow-md sticky top-0 z-50 transition-colors duration-300`}>
          ...
          <div className="flex justify-between items-center h-16">
           ...
           <div className="flex items-center gap-2">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button className={`${secondaryTextClass} hover:text-blue-600 transition-colors`}>
                Courses
              </button>
              <button className={`${secondaryTextClass} hover:text-blue-600 transition-colors`}>
                Problems
            ...
            <div className="flex items-center space-x-4">
              <button onClick={toggleTheme} className="p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">
                {darkMode ? <Sun size={20} className={textClass} /> : <Moon size={20} className={textClass} />}
              </button>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <h1 className={`text-3xl font-bold ${textClass} mb-6`}>Announcements</h1>

            {announcements.map((announcement) => (
              <div key={announcement.id} className={`${cardBgClass} rounded-2xl shadow-md p-6 transition-colors duration-300`}>
                {/* Post Header */}
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <h3 className={`font-bold ${textClass}`}>{announcement.user.name}</h3>
                    <p className={`text-sm ${secondaryTextClass}`}>{announcement.user.role}</p>
                    <p className={`text-xs ${secondaryTextClass}`}>{announcement.user.time}</p>
                  </div>
                </div>
                ...
                {/* Action Buttons */}
                <div className={`flex items-center gap-4 mt-4 pt-4 border-t ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
          ...
          <div className="space-y-6">
            {/* Search Box */}
            <div className={`${cardBgClass} rounded-2xl shadow-md p-4 transition-colors duration-300`}>
            ...
            {/* Top Rated Section */}
            <div className={`${cardBgClass} rounded-2xl shadow-md p-6 transition-colors duration-300`}>
                ...
                {topRatedUsers.map((user) => (
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      <div className={`absolute -top-1 -left-1 w-6 h-6 ${getRankBadgeColor(user.rank)} rounded-full flex items-center justify-center text-white text-xs font-bold shadow-md`}>
                        #{user.rank}
                      </div>
                    </div>
                    ...
                    <div className="flex-1">
                      ...
                      <p className={`text-sm ${secondaryTextClass}`}>{user.level}</p>
                    </div>

                    {/* Points Badge */}
                    <div className={`${getRankBadgeColor(user.rank)} text-white px-4 py-2 rounded-full font-bold text-sm shadow-lg`}>
                      {user.points}
                    </div>
                  </div>
                ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center gap-2 mb-6 md:mb-0">
              ...
              <span className="text-xl font-semibold">SkillNet</span>
            </div>

            {/* Social Links */}
            <div className="flex items-center gap-4 mb-6 md:mb-0">
              <a href="#" className="w-10 h-10 rounded-full border-2 border-gray-600 flex items-center justify-center hover:border-blue-600 transition-colors">
            ...
            <div className="flex items-center gap-6">
              ...
              <a href="#" className="text-sm text-gray-400 hover:text-white transition-colors">Courses</a>
              <a href="#" className="text-sm text-gray-400 hover:text-white transition-colors">Problems</a>
          ...
          <div className="text-center mt-8 pt-8 border-t border-gray-800">
            <p className="text-sm text-gray-400">© 2025 Cubed Community. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
